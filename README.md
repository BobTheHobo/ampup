...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.0.6.1--beta-00BFEF" alt="Version" />
...
1. Download **`AmpUp-Setup-1.0.6.1-beta.exe`** from [Releases](https://github.com/audioslayer/ampup/releases).
2. Run the installer.
